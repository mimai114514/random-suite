...
Write-Host "========================================" -ForegroundColor Cyan
Set-Location "$rootDir\random-floating\Random_FloatingTool"
dotnet publish -c Release
if ($LASTEXITCODE -ne 0) {
    Write-Host "FT Build Failed!" -ForegroundColor Red
    exit $LASTEXITCODE
}
$ftPublishDir = "$rootDir\random-floating\Random_FloatingTool\bin\Release\net8.0-windows10.0.19041.0\publish"
...
Write-Host "========================================" -ForegroundColor Cyan
Set-Location "$rootDir\.github\installer"
